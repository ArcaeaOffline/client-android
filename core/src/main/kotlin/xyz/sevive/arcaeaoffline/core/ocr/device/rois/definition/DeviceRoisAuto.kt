...
//        get() = this.h / 2.0
    ...
    override val pure
        get() =
            doubleArrayOf(
                this.pflX,
                this.layoutAreaHMid + 110.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val far
        get() =
            doubleArrayOf(
                this.pflX,
                this.pure[1] + this.pure[3] + 12.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val lost
        get() =
            doubleArrayOf(
                this.pflX,
                this.far[1] + this.far[3] + 10.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val score: DoubleArray
        get() {
            ...
            return doubleArrayOf(
                this.wMid - w / 2,
                this.layoutAreaHMid - 75 * this.factor - h,
                w,
                h,
            )
        }
...
//        get() = 60 * this.factor
    ...
    override val pure: DoubleArray
        get() =
            doubleArrayOf(
                this.pflX,
                this.layoutAreaHMid + 175.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val far: DoubleArray
        get() =
            doubleArrayOf(
                this.pflX,
                this.pure[1] + this.pure[3] + 30.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val lost: DoubleArray
        get() =
            doubleArrayOf(
                this.pflX,
                this.far[1] + this.far[3] + 35.0 * this.factor,
                this.pflW,
                this.pflH,
            )
    ...
    override val score: DoubleArray
        get() {
            ...
            return doubleArrayOf(
                this.wMid - w / 2.0,
                this.layoutAreaHMid - 110 * this.factor - h,
                w,
                h,
            )
        }
